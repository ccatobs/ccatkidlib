...
# Ideally we will fit a few higher power resonators, choose a tone power based on fitted resonators, and take noise. For now just take noise.
...
def main():
    ...
    drive_attens = [0,3,6,9, 12, 15, 18, 21, 24]# DAC attenuations
...
def coldload_sweep(R, coldload_cfg, attens, noise_attens, restart = False):
    ...
    psu.set_voltage(channel = 1, volts = 15)
