# ccatkidlib
[Xilinx ZCU111 Radio Frequency System on a Chip](https://www.amd.com/en/products/adaptive-socs-and-fpgas/evaluation-boards/zcu111.html) (RFSoC) based data acquisition and analysis library for the [CCAT Observatory](https://www.ccatobservatory.org/)'s [Prime-Cam](https://www.ccatobservatory.org/prime-cam/) instrument kinetic inductance detectors (KIDs).
