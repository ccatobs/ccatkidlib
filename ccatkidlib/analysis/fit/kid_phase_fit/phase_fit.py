...
import yaml
from ccatkidlib.analysis.fit.kid_phase_fit.utils import *
from ccatkidlib.analysis.fit.kid_phase_fit.fit_single_det import ResonanceFitterSingleTone as fit
...
def fit_target_sweep(targ_file=None, cfg_file=None, verb=False, keep_model=False,  **kwargs):
    ...
    bin_width = config['tones']['sweep_steps'] #config['tones']['N_step']
    print(bin_width)
